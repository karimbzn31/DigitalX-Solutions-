...
const founders = [
  {
    ...
    bio: "Passionné par l'intelligence artificielle et le développement SaaS. Karim a formé une cinquantaine d'entrepreneurs en Algérie. Il croit fermement que l'IA est le levier le plus puissant pour transformer des idées en entreprises.",
    initials: "KB",
  ...
  },
  {
    ...
    bio: "Développeur full-stack avec 5 ans d'expérience dans le web et les technologies cloud. Imad a lancé plusieurs startups SaaS avant de co-fonder cette académie. Sa mission : démocratiser l'accès aux compétences tech en Algérie.",
    initials: "IB",
