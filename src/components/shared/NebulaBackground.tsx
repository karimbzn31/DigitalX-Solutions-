...
const masses: Mass[] = [
  {
    ...
    x: 10,
    y: 15,
    br1: 60, br2: 40, br3: 30, br4: 70,
    delay: 0,
    duration: 22,
  },
  {
    id: 2,
    color: "rgba(196, 92, 255, 0.18)",
    width: 600,
    height: 500,
    x: 55,
    y: 50,
    br1: 40, br2: 60, br3: 70, br4: 30,
    delay: 3,
    duration: 25,
  },
  {
    id: 3,
    color: "rgba(255, 111, 184, 0.12)",
    width: 400,
    height: 350,
    x: 75,
    y: 20,
    br1: 50, br2: 30, br3: 60, br4: 40,
    delay: 6,
    duration: 18,
  },
  {
    id: 4,
    color: "rgba(92, 201, 255, 0.10)",
    width: 500,
    height: 450,
    x: 25,
    y: 65,
    br1: 30, br2: 50, br3: 40, br4: 60,
    delay: 2,
    duration: 20,
  },
];
  ...
  return (
    <div className="fixed inset-0 z-0 pointer-events-none overflow-hidden bg-void" style={{ opacity: intensity }}>
      ...
      <motion.div style={{ y: parallaxY }} className="absolute inset-0">
        {masses.map((m) => {
          const xMove = (m.x > 50 ? -1 : 1) * 30;
          const yMove = (m.y > 50 ? -1 : 1) * 20;
          return (
            <motion.div
              key={m.id}
              className="absolute blur-[150px]"
              style={{
                width: m.width,
                height: m.height,
                background: m.color,
