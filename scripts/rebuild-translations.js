...
// Check if we just need to close the object or rebuild
const trimmed = c.trimEnd();
if (trimmed.endsWith('"formations.demanderIA": "Demander à DigitalX IA",')) {
  // File is missing closing brace and AR section - append them
  const rest = `
...
export const ar: Record<TranslationKey, string> = {
  ...
  "features.f2d": "طور برامجك 10 أسرع مع الذكاء الاصطناعي التوليدي والبرمجة الثنائية.",
  "features.f3t": "إنشاء SaaS الخاص بك",
  "features.f3d": "من الفكرة إلى المنتج على الإنترنت. تقنية، نشر، توسيع.",
  "features.f4t": "وكيل الذكاء الاصطناعي الشخصي",
  ...
  "stats.1": "تكوينا في البرنامج",
  "stats.2": "متعلما مسجلا",
  ...
  "moduleZero.subtitle": "أتقن الذكاء الاصطناعي و Vibe Coding وتطوير SaaS. ابن منتجات حقيقية. أطلق شركتك الناشئة.",
  "moduleZero.pourquoiTitre": "لماذا نحن؟",
  "moduleZero.pourquoiDesc": "نحن لا نقدم نظرية فقط. هنا، تتعلم من خلال بناء مشاريع حقيقية. تخرج بمهارات تدر عليك المال، وليس مجرد شهادة.",
  "moduleZero.obtiens": "ما تحصل عليه مجانا:",
  ...
  "moduleZero.item4d": "تعلم الإنشاء والنشر والربح",
  "moduleZero.imagine": "تخيل بعد إتمام تكويناتنا...",
  "moduleZero.revenu": "مشاريع تدر عليك دخلا حقيقيا. ليست نظرية، بل نتائج.",
  ...
  "cta.titre2": "المستقبل",
  "cta.titre3": "؟",
  "cta.desc": "انضم إلى أكثر من {count} متعلما يحولون أفكارهم إلى شركات ناشئة بالذكاء الاصطناعي.",
  "cta.btn": "ابدأ الآن ←",
  "cta.contact": "اتصل بنا",
  "cta.footer": "✦ الجزائر وما بعدها ✦",
  "login.bienvenue": "سعداء بعودتك",
  "login.subtitle": "سجل الدخول لمواصلة تكوينك",
  ...
  "register.enCours": "جار التسجيل...",
  "register.nom": "الاسم الكامل",
  "register.email": "البريد الإلكتروني",
  "register.password": "كلمة المرور",
  "forgot.titre": "نسيت كلمة المرور",
  "forgot.subtitle": "أدخل بريدك الإلكتروني وسنرسل لك رابطا لإعادة تعيين كلمة المرور",
  "forgot.envoyer": "إرسال الرابط",
  "forgot.retour": "العودة إلى تسجيل الدخول",
  "forgot.envoi": "جار الإرسال...",
  ...
  "chat.welcome": "مرحبا {name}! أنا مرشد أكاديمية ديجيتال إكس سوليوشنز. اسألني عن Vibe Coding أو الذكاء الاصطناعي أو SaaS أو التكوينات.",
  "chat.placeholder": "اطرح سؤالك...",
  "chat.indisponible": "الخدمة غير متاحة حاليا.",
  "legal.titre": "الإشعار القانوني وشروط الاستخدام",
  "legal.sousTitre": "معلومات قانونية بخصوص أكاديمية ديجيتال إكس سوليوشنز",
  "dashboardHero.salut": "مرحبا {name} \u{1F44B}",
  ...
  "formations.heroDesc": "استكشف كتالوج التكوينات المصممة لجعلك خبيرا في الذكاء الاصطناعي والأتمتة وإنشاء الشركات الناشئة. كل تكوين عملي 100%.",
...
`;
  fs.writeFileSync("./src/lib/translations.ts", c + rest);
  console.log("✅ File rebuilt successfully");
} else {
  console.log("Unexpected file state - check manually");
}
